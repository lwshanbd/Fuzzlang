...
One binary, both directions. The DVCR verifier (`experiments/verifier/fuzzlang.py`) calls `diagtool find-diagnostic-id <integer>` to recover the diag name from the ID printed by Patch 1.

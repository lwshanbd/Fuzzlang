...
audit.  The latest independent live audit reports **937 / 3,891** catalog
error types, backed by 6,526 paired records and 8,183 unique portable
...
separately (605 types).  It rejects records that lack the concrete Injector
